...
Visual Studio Code имеет встроенную поддержку Git. Вам потребуется установить Git версии не ниже 2.0.0.
...
В редакторе можно выполнить основные операции Git:
Инициализация репозитория.
Клонирование репозитория.
Создание веток и тегов.
Индексация изменений и создание коммитов.
Push/pull/sync с удаленной веткой.
мнение мнения слияния.
Просмотр изменений.
С помощью плагина можно работать с запросами слияний на GitHub: https://marketplace.visualstudio.com/items?itemName=GitHub.vscode-pull-request-github .
